...
axiosInstance.interceptors.request.use(
    (config) => {
        const token =
            ...
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3YTcwODdkNjhhYTNmNGViYzFlYTFjYyIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTczOTc3NTExNiwiZXhwIjoxNzM5ODYxNTE2fQ.tv5w6GRgW1c75de2qMtnGuybj-SSI8w8huvUBb4B5Ww"; // Fallback token for development
