...
export const StudentCustomInput = React.memo(function StudentCustomInput({
    label,
    type = "text",
    registerOptions,
    error,
...
*/
export const StudentCustomTextarea = React.memo(function StudentCustomTextarea({
    label,
    registerOptions,
    error,
    disabled,
        ...
        <div>
            ...
            <textarea
                ...
                className="mt-1 block w-full rounded-md border border-gray-200 shadow-sm 
                   focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 px-3 py-2 outline-none"
            ></textarea>
            {error && (
                <p className="mt-1 text-sm text-red-600">{error.message}</p>
            )}
...
/* 
  ...
  Props:
    ...
    - ...rest: Any other additional props.
*/
export const StudentCustomSelect = React.memo(function StudentCustomSelect({
    label,
    registerOptions,
    error,
    disabled,
...
export const StudentCustomToggale = ({ isChecked, setChecked }) => {
    return (
