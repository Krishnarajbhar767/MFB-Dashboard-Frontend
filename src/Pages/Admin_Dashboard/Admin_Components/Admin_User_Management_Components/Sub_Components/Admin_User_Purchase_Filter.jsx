...
function Admin_User_Purchase_Filter({ setIsFilterOpen }) {
    ...
    return (
        <div className=" fixed h-[70px]  top-[17.5vh]  left-auto right-auto z-50 w-[77%]  mx-3 mt-8  bg-gray-100 p-4 shadow-md rounded-md  flex items-center justify-between border border-gray-300">
