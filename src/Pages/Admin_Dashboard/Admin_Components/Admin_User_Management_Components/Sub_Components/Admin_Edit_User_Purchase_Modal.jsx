...
function Admin_Edit_User_Purchase_Modal({ tableData, setTableData }) {
    ...
    const formHandler = async (data) => {
        ...
        setConfirmationModal({
            ...
            btn1Handler: async () => {
                ...
                try {
                    console.log(
                        "Printing User Data From Confirmation Modal....",
                        data
                    );
    ...
    return (
        <div
            ...
            className="capitalize fixed w-[40vw] h-[90vh] bg-gray-100 border-gray-400 z-50 border rounded-lg  bottom-10 left-[33%] right-auto p-4"
        >
            <p
            ...
            >
                <div className="flex flex-col">
                    ...
                    <input
                        type="text"
                        id="trackingId"
                        defaultValue={tableData?.trackingId}
                        {...register("trackingId")}
                        disabled
                    />
